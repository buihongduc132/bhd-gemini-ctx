...
Final implementation based on search page discovery and proper network handling.
"""
...
class GeminiConversationExtractor:
    ...
    async def _save_conversation(self, html_content, title, url):
        """Save conversation in multiple formats using markitdown."""
...
*Extracted from Gemini conversation using search page method with markitdown conversion*
"""
        ...
        metadata = {
            ...
            "extraction_method": "search_page_click_with_markitdown",
